...
class LLMService:
    ...
    def __init__(
        self,
        provider: OllamaService | None = None,
    ) -> None:
        """
        ...
        self._provider = provider or OllamaService.from_config(get_application_config())

    @classmethod
    def from_config(cls, config: ApplicationConfig) -> LLMService:
        """Construct the LLM facade from ApplicationConfig."""

        return cls(provider=OllamaService.from_config(config))
